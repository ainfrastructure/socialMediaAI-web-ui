              ...
              <div v-if="businessId" class="filter-toggle-container">
                ...
                >
                  ...
                  <span class="filter-toggle-text">
                    {{ showAllBusinesses ? $t('pickPostModal.showCurrentBusiness') : $t('pickPostModal.showAllBusinesses') }}
                  </span>
                </button>
              </div>
              ...
              <div class="posts-grid">
                ...
                >
                  ...
                  <div class="post-info">
                    ...
                    <div v-if="post.saved_businesses?.name" class="business-tag">
                      🏪 {{ post.saved_businesses.name }}
                    </div>
                  </div>
                </div>
              </div>
...
// Reset pagination when business filter changes
...
const filteredPosts = computed(() => {
  ...
  return posts.value.filter(post => post.business_id === props.businessId)
})
