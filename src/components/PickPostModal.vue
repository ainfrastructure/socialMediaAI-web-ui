<template>
  ...
  >
          ...
          <div v-if="currentStep === 1" class="wizard-step">
            ...
            <!-- Posts Grid -->
            <div v-else>
              <!-- Business Filter Toggle (only show if brandId is provided) -->
              <div v-if="brandId" class="filter-toggle-container">
                <button
                  type="button"
...
// Filter posts by brand if brandId is provided (unless showAllBusinesses is true)
