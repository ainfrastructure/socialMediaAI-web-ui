  ...
  <div class="autocomplete-container">
    ...
    <div v-if="showDropdown" class="autocomplete-dropdown" ref="dropdownRef">
      ...
      <div
        ...
        :class="['dropdown-item', { active: index === activeIndex, saved: isBrandSaved(suggestion) }]"
        @mousedown.prevent="selectSuggestion(suggestion)"
        @mouseenter="activeIndex = index"
      >
        <div class="brand-info">
          <div class="brand-name">{{ suggestion.name }}</div>
          <div class="brand-address">{{ suggestion.address }}</div>
        </div>
        <div v-if="isBrandSaved(suggestion)" class="saved-badge">
