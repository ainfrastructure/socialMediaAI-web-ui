...
// Watch business changes → reset page
watch(() => analytics.selectedBusinessId.value, () => {
...
onMounted(async () => {
  ...
  await analytics.businessesStore.fetchBusinesses()
  if (!analytics.selectedBusinessId.value && analytics.businessesStore.businesses.length > 0) {
    analytics.preferencesStore.setSelectedBusiness(analytics.businessesStore.businesses[0].id)
  }
  ...
  <DashboardLayout>
    <div class="analytics-view">
      ...
      <AnalyticsHeader
        ...
        :selected-business-id="analytics.selectedBusinessId.value"
        :businesses="analytics.businessesStore.businesses"
        :selected-business="analytics.selectedBusiness.value"
        @update:selected-time-range="analytics.handleTimeRangeChange"
        @update:selected-business-id="analytics.selectedBusinessId.value = $event"
      ...
      <template v-else>
        ...
        <AnalyticsTopPosts
          ...
          :get-business-name="analytics.getBusinessName"
        ...
        <div class="charts-grid">
          ...
          <AnalyticsUsageCard
            ...
            :business-count="analytics.stats.value.restaurantsAdded"
          />
        </div>
