export default {
  ...
  landing: {
    ...
    examples: {
      ...
      flow: {
        ...
        step1Description: 'Snap a photo of your business with your phone. No professional camera needed.',
    ...
    autoPosting: {
      ...
      feature1: 'Posts go live while you work',
    ...
    benefits: {
      ...
      time: {
        ...
        description: 'Stop wrestling with content creation. Spend that time on what matters - your business and customers.'
      },
      professional: {
      ...
      easy: {
        ...
        description:
          "If you can take a photo, you can use SocialChef. That's it."
      }
    },
  ...
  analytics: {
    ...
    // Empty State
    emptyStateTitle: 'Time to create some posts!',
  ...
  appLanding: {
    ...
    pricing: {
      ...
      subtitle: 'Choose the plan that fits your business. Save 50% with annual billing.',
      monthly: 'Monthly',
      annual: 'Annual',
      save: 'Save 50%',
      month: 'mo',
      ...
      pro: 'Pro',
      business: 'Business',
      yearlySavePro: 'Save $474/yr',
      yearlySaveBusiness: 'Save $894/yr',
      featureAiChat: 'AI chat & content creation',
      featurePlanning: 'Content planning & calendar',
      featurePublishing: 'Post management & publishing',
      featureAnalytics: 'Analytics & insights',
      featureDesign: 'Design studio',
      featureAds: 'Google, Facebook & Pinterest Ads',
      featureAssets: 'Asset management',
      featureTeam: 'Team collaboration',
      featureBrandVoice: 'Brand voice training',
      featureCompetitor: 'Competitor intelligence',
      featureMultiBrand: 'Multi-brand management',
    ...
    aiCreation: {
      ...
      scheduleDesc: 'Any platform, any time. Schedule feed posts, reels, stories, carousels and more — or let SocialChef pick the best time for your audience.',
      scheduleStageDesc: 'Any platform, any format, at the perfect time',
      ...
      dayThu: 'Thu',
      dayFri: 'Fri',
      postBrandName: 'Your Brand',
      postTimestamp: 'Just now',
      postTabFeed: 'Feed',
      postTabReel: 'Reel',
      postTabStory: 'Story',
    ...
    calendar: {
      ...
      bulkImportDesc: 'Import content plans from CSV or XLSX files',
      ...
      post1: 'New summer collection — fresh styles dropping...',
      post2: 'Our most popular service, now with a new...',
      post3: 'Top 5 things our customers loved this month...',
      post4: 'Behind the scenes at our studio today...',
      post5: 'Weekend special offers — book your spot...',
      post6: 'New arrivals just landed from our suppliers...',
    },
    adsManager: {
      eyebrow: 'Ads Manager',
    ...
    cinematic: {
      featureTitleChat: 'AI Chat Assistant',
      featureDescChat: 'Tell it what you need — it knows your brand.',
      featureTitleStrategy: 'Smart Content Strategy',
      featureDescStrategy: 'A full week of posts, planned in seconds.',
      featureTitleDesign: 'Built-In Design Studio',
      featureDescDesign: 'Edit visuals without leaving the app.',
      featureTitlePublish: 'One-Click Publishing',
      featureDescPublish: 'Post to every platform simultaneously.',
      featureTitleCalendar: 'Visual Content Calendar',
      featureDescCalendar: 'See your entire schedule at a glance.',
      featureTitleAnalytics: 'Real-Time Analytics',
      featureDescAnalytics: 'Track performance across all platforms.',
      featureTitleAds: 'Ad Campaign Manager',
      featureDescAds: 'Launch paid campaigns in minutes.',
      featureTitleCta: 'Ready to Start?',
      ...
      chatCalendarTitle: 'Weekly Content Plan',
      planMonDay: 'Mon',
      planMonDesc: 'Thought leadership article',
      planWedDay: 'Wed',
      planWedDesc: 'Team culture behind-the-scenes',
      planFriDay: 'Fri',
      planFriDesc: 'Product feature spotlight',
      chatCalendarCount: '3 posts optimized per platform',
      chatUserReply2: 'Perfect — publish the thought leadership post now!',
      chatInputPlaceholder: 'Message...',
      attachTakePhoto: 'Take Photo',
      attachChooseAssets: 'Choose from Assets',
      attachDesignStudio: 'Design Studio',
      designTitle: 'Design Studio',
      designCropBg: 'Crop BG',
      designRatio: 'Ratio',
      designText: 'Text',
      designDraw: 'Draw',
      designCta: 'CTA',
      designOverlayText: 'The Future of Hiring',
      designPrompt: 'Add our brand gradient and clean typography',
      publishWhere: 'Where would you like to publish?',
      publishCaption: 'How We Grew 340% in Q1: The Strategy Behind the Numbers',
      publishHashtag1: '#Web3',
      publishHashtag2: '#FutureOfWork',
      publishFeed: 'Feed',
      publishStory: 'Story',
      ...
      analyticsPublished: 'Published',
      analyticsPosts: 'Posts',
      analyticsTotalSpend: 'Total Spend',
      analyticsCtr: 'CTR',
      analyticsPerformanceTrend: 'Performance Trend',
      analyticsOrganic: 'Organic',
      analyticsPaid: 'Paid',
      analytics7Days: '7 Days',
      analytics30Days: '30 Days',
      analytics90Days: '90 Days',
      analyticsChartTitle: 'Engagement Over Time',
      analyticsPlatformTitle: 'Platform Performance',
      calTitle: 'Calendar',
      calBrand: 'Vetted',
      calMonth: 'March 2026',
      calSelectedDay: 'Wednesday, March 25',
      calPostTitle: 'Personalized Interaction',
      calPostPlatform: 'Facebook',
      calPostStatus: 'Scheduled 10:00',
      calPost2Title: 'Summer Vibes Collection',
      calPost2Platform: 'Instagram',
      calPost2Status: 'Scheduled 14:00',
      adsCreateTitle: 'Create Campaign',
      adsPlatformLabel: 'Platform',
      adsObjectiveLabel: 'Objective',
      adsObjectiveReach: 'Reach',
      adsObjectiveEngagement: 'Engagement',
      adsObjectiveClicks: 'Clicks',
      adsBudgetLabel: 'Daily Budget',
      adsDurationLabel: 'Duration',
      adsBudgetValue: '250 kr / day',
      adsDurationValue: '7 days',
      adsLaunch: 'Launch Campaign',
      adsSuccessTitle: 'Campaign Created!',
      adsEstReach: 'Est. Reach',
      adsTotalBudget: 'Total Budget',
      adsEstCtr: 'Est. CTR',
      publishCardIntro: "Here's your post, ready to go:",
      publishedBadge: 'Published',
      publishedDate: 'Tue, 17 March · 20:41',
      publishedAgo: '1d ago',
      publishedAccount: 'SocialChef',
      publishedFeedLink: 'Feed',
      publishedMoreLikeThis: 'More like this',
    ...
    designBuilder: {
      ...
      videoDesc: 'AI-powered video from text or images',
      branding: 'Brand Kit',
    ...
    aiAssistant: {
      ...
      title: 'Your Creative Partner, On Call 24/7',
      subtitle: 'Describe what you need and let AI create on-brand posts, images, and videos — with your voice, colors, and style built in.',
      smartCreation: 'Smart Creation',
      smartCreationDesc: 'Describe what you want, AI creates it',
      brandVoice: 'Brand Voice Match',
      brandVoiceDesc: 'Content matches your unique tone automatically',
      multiFormat: 'Multi-Format Output',
      multiFormatDesc: 'Posts, stories, reels, and carousels from one prompt',
      refinement: 'Iterate & Polish',
      refinementDesc: 'Refine until it\'s perfect, AI learns your preferences',
      userPrompt: 'What should I post this week? I want to grow engagement.',
      aiResponse: 'Based on your analytics, Reels are driving 3x more reach. I suggest a mix: 2 Reels, 1 carousel, and 1 story poll.',
      aiGenerated: 'I\'ve drafted all 4 posts with captions, hashtags, and image concepts — ready for your review.',
      userReply: 'Love it — schedule the Reels for Tuesday and Thursday',
      aiConfirm: 'Done! Reels scheduled at optimal times. I\'ll auto-publish to Instagram, TikTok, and Facebook.',
    },
    publishing: {
      eyebrow: 'Multi-Platform Publishing',
      title: 'One Click. Every Platform.',
      subtitle: 'Publish to Facebook, Instagram, TikTok, X, LinkedIn, and Pinterest simultaneously — each post auto-optimized per platform.',
      oneClick: 'One-Click Publish',
      oneClickDesc: 'Send to all platforms simultaneously',
      platformOptimize: 'Platform Optimization',
      platformOptimizeDesc: 'Auto-adjusts format, hashtags, and length per platform',
      sixPlatforms: '6+ Platforms',
      sixPlatformsDesc: 'Facebook, Instagram, TikTok, X, LinkedIn, Pinterest',
      smartTiming: 'Smart Timing',
      smartTimingDesc: 'AI picks the optimal posting time per platform',
      postTitle: 'Summer Menu Launch',
      sent: 'Sent',
      optimized: 'Optimized',
    },
    testimonials: {
      eyebrow: 'Testimonials',
      title: 'Loved by SMEs Everywhere',
      ...
      testimonial4: 'As a business owner, I never had time for social media. SocialChef handles everything — from professional posts to seasonal promotions. My online bookings have doubled.',
      testimonial5: 'Running a car wash means my hands are always full. SocialChef keeps our social media active with zero effort. Customers tell me they found us through Instagram now.',
      decentralizedHiringCeo: 'CEO, Decentralized Hiring Platform',
      orderingPlatformCeo: 'CEO, Ordering Platform',
      resortOwner: 'Resort Owner',
      businessOwner: 'Business Owner',
      luxCarWashOwner: 'Owner, Lux Bilpleie'
    },
    earlyBird: {
