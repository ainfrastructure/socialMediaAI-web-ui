export default {
  ...
  appLanding: {
    ...
    cinematic: {
      ...
      stepChatGreeting: 'Hi! I analyzed your brand. Ready to create content that matches your voice?',
      stepChatUserMessage: 'Create a LinkedIn post about our Q1 growth strategy',
      stepStrategyResponse: 'Here\'s your content plan for maximum engagement:',
      stepStrategyCard1: 'Industry insights thread',
      stepStrategyCard2: 'Behind-the-scenes story',
      stepStrategyCard3: 'Data-driven case study',
      stepStrategyDay1: 'Mon',
      stepStrategyDay2: 'Wed',
      stepStrategyDay3: 'Fri',
      stepStrategyGenerate: 'Generate First Post →',
      stepDesignChoose: 'Choose a Template',
      stepDesignLayer1: 'Background',
      stepDesignLayer2: 'Image',
      stepDesignLayer3: 'Text',
      stepDesignLayer4: 'Logo',
      stepDesignPremium: 'PRO',
      stepCreateTag: 'Growth Strategy',
      stepCreateHeadline: 'How We Grew 340% in Q1: The Strategy Behind the Numbers',
      stepCreateBrand: 'YOUR BRAND',
      stepCreateHashtag1: '#LinkedInGrowth',
      stepCreateHashtag2: '#ContentStrategy',
      stepCreateHashtag3: '#B2B',
      stepCreateSparkle: 'AI-generated ✨',
      ...
      stepScheduleThu: 'Thu',
      stepScheduleFri: 'Fri',
      stepScheduleBestTime: '10:30 AM — Best for LinkedIn',
      stepAnalyticsLikes: 'Likes',
      stepAnalyticsComments: 'Comments',
      stepAnalyticsReach: 'Reach',
      stepAnalyticsShares: 'Shares',
      stepAnalyticsTopPost: 'Top Post',
      stepAnalyticsCta: 'Start Creating',
    },
    featureShowcase: {
