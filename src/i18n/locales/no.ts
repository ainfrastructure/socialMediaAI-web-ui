export default {
  ...
  appLanding: {
    ...
    cinematic: {
      pillChat: 'Chat',
      pillStrategy: 'Strategi',
      pillDesign: 'Design',
      pillCreate: 'Lag',
      pillAdapt: 'Tilpass',
      pillSchedule: 'Planlegg',
      pillAnalytics: 'Analyse',
      stepChatGreeting: 'Hei! Jeg har analysert merkevaren din. Klar til å lage innhold som matcher stemmen din?',
      stepChatUserMessage: 'Lag et LinkedIn-innlegg om vår Q1-vekststrategi',
      stepStrategyResponse: 'Her er innholdsplanen din for maksimalt engasjement:',
      stepStrategyCard1: 'Bransjeinnsikt-tråd',
      stepStrategyCard2: 'Bak kulissene-historie',
      stepStrategyCard3: 'Datadrevet casestudie',
      stepStrategyDay1: 'Man',
      stepStrategyDay2: 'Ons',
      stepStrategyDay3: 'Fre',
      stepStrategyGenerate: 'Generer første innlegg →',
      stepDesignChoose: 'Velg en mal',
      stepDesignLayer1: 'Bakgrunn',
      stepDesignLayer2: 'Bilde',
      stepDesignLayer3: 'Tekst',
      stepDesignLayer4: 'Logo',
      stepDesignPremium: 'PRO',
      stepCreateTag: 'Vekststrategi',
      stepCreateHeadline: 'Hvordan vi vokste 340% i Q1: Strategien bak tallene',
      stepCreateBrand: 'DIN MERKEVARE',
      stepCreateHashtag1: '#LinkedInVekst',
      stepCreateHashtag2: '#Innholdsstrategi',
      stepCreateHashtag3: '#B2B',
      stepCreateSparkle: 'AI-generert ✨',
      stepAdaptCharCount: '2 847 / 3 000',
      stepScheduleMon: 'Man',
      stepScheduleTue: 'Tir',
      stepScheduleWed: 'Ons',
      stepScheduleThu: 'Tor',
      stepScheduleFri: 'Fre',
      stepScheduleBestTime: '10:30 — Best for LinkedIn',
      stepAnalyticsLikes: 'Likerklikk',
      stepAnalyticsComments: 'Kommentarer',
      stepAnalyticsReach: 'Rekkevidde',
      stepAnalyticsShares: 'Delinger',
      stepAnalyticsTopPost: 'Toppinnlegg',
      stepAnalyticsCta: 'Begynn å lage',
    },
    featureShowcase: {
